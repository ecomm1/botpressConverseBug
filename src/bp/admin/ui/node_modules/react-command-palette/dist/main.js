	...
	*/
	...
	var CustomSpinnerComponent = function CustomSpinnerComponent(props) {
	  ...
	  return React.createElement("div", {
	    className: cssClass,
	    role: "status"
	  }, typeof spinner !== "string" ? React.createElement("span", {
	    className: "sr-only"
	...
	function PaletteSpinner(props) {
	  ...
	  if (spinner) {
	    return React.createElement(CustomSpinnerComponent, props);
	  }

	  return React.createElement(DefaultSpinnerComponent, {
	    display: display,
	    theme: theme
	  });
	}
	...
	var RenderCommand = function RenderCommand(props) {
	  ...
	  if (renderCommand) {
	    return React.createElement("div", null, renderCommand(suggestion));
	  }

	  return React.createElement(DefaultCommand, {
	...
	function PaletteTrigger(props) {
	  ...
	  if (trigger) {
	    return React.createElement(CustomTriggerComponent, {
	      onClick: onClick,
	      trigger: trigger,
	      theme: theme
	    });
	  ...
	  return React.createElement(DefaultTriggerComponent, {
	    onClick: onClick,
	    theme: theme
	  });
	}
	...
	function formatSuggestions(filteredSuggestions) {
	  return filteredSuggestions.map(function (suggestion) {
	    ...
	    return _objectSpread({}, opts, {}, suggestion.obj);
	  });
	...
	function (_React$Component) {
	  ...
	  function CommandPalette(props) {
	    ...
	    _this = possibleConstructorReturn(this, getPrototypeOf(CommandPalette).call(this, props));
	  ...
	  createClass(CommandPalette, [{
	    ...
	    value: function focusInput() {
	      ...
	      mousetrap(this.commandPaletteInput.input).bind(["esc"].concat(hotKeys), function () {
	    ...
	    value: function commandTemplate(suggestion) {
	      return React.createElement(RenderCommand, _extends_1({}, this.props, {
	        suggestion: suggestion
	      }));
	    ...
	    value: function renderAutoSuggest() {
	      ...
	      if (isLoading && showSpinnerOnSelect) {
	        return React.createElement(PaletteSpinner, {
	          spinner: spinner,
	          display: display,
	          theme: theme.spinner
	        });
	      ...
	      return React.createElement("div", null, React.createElement(Header, {
	        theme: theme
	      }, header), React.createElement(dist$3, {
